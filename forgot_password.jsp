...
<head>
    ...
    body {
      ...
      background-image: url('../assets/login_background_img2.jpg'); /* 🔁 Replace with your image path */
...
<%
    ...
    if (request.getParameter("sendOtp") != null) {
        ...
        try {
            ...
            PreparedStatement empStmt = con.prepareStatement("SELECT emp_id FROM employee74 WHERE LOWER(email)=LOWER(?)");

            empStmt.setString(1, empEmail);
            ResultSet empRs = empStmt.executeQuery();

            String empId = null;
            if (empRs.next()) {
                empId = empRs.getString("emp_id");
            } else {
            ...
            if (empId != null) {
                // Check admin email
                PreparedStatement adminStmt = con.prepareStatement("SELECT * FROM employee74 WHERE email=? AND role_type='Admin'");
                ...
                if (adminRs.next()) {
                    ...
                    // Email sending logic
                    final String fromEmail = "shaganti74@gmail.com";
                    final String password = "fjdcjmhxkyqzyjlt"; // App Password
                    ...
                    msg.setSubject("Employee Forgot Password Request");
                    msg.setText("OTP for reset: " + otp + "\nEmployee ID: " + empId + "\nEmployee Email: " + empEmail);
                    System.out.println("Sending OTP to Admin:\nEmployee ID: " + empId + "\nEmployee Email: " + empEmail);
  ...
  <div class="container py-4">
    <div class="row align-items-center justify-content-center">
      ...
      <div class="col-12 col-md-6 col-lg-4">
        <div class="forgot-password-container border rounded p-4 shadow bg-white">
        <div class="text-center mb-3">
            <!-- this base64 image with your actual logo if needed -->
        ...
        <h4 class="text-center mb-3"  style="color: black;">Forgot Password</h4>
        <form method="post">
            <div class="mb-3">
                <label for="emp_email" class="form-label">Your Email</label>
                <input type="email" name="emp_email" id="emp_email" class="form-control" required>
            </div>
            <div class="mb-3">
                <label for="admin_email" class="form-label">Admin Email</label>
                <input type="email" name="admin_email" id="admin_email" class="form-control" value="shaganti74@gmail.com" required>
            </div>
            <input type="submit" name="sendOtp" value="Send OTP" class="btn btn-primary w-100">
        </form>
        <p class="mt-3 text-center <%= message.contains("✅") ? "text-success" : "text-danger" %>">
            <%= message %>
        </p>
